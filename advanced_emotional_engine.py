...
class EmotionalProcess:
    ...
    def start(self):
        """Start emotional engine as independent process (HARDENED with timeouts + validation)"""
            ...
            try:
                ...
                try:
                    ...
                    while len(length_data) < 4:
                        ...
                        if not chunk:
                            raise IOError("EOF while reading length header")
                        length_data += chunk
                    ...
                    result = self.process_message_safe(message)
