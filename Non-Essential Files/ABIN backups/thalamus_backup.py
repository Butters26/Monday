...
class Thalamus:
    ...
    def process_user_input(self, user_input: str) -> str:
        ...
        reasoning_input = {
            ...
            'patterns': patterns,
            'highly_active_concepts': highly_active if 'highly_active' in locals() else []
        }
        ...
        if reasoning_result.get('status') == 'success':
            ...
            composed_response = thinking.get('composed_response', user_input)
            print(f"   <- Response composed")
        else:
            composed_response = user_input
            print(f"   <- Error in reasoning")
        ...
        # Store in Notus (direct connection)
