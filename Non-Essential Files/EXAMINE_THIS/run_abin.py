...
def cleanup_sockets():
    ...
    sockets = [
        ...
        "/tmp/output.sock", "/tmp/thalamus.sock", "/tmp/language.sock"
    ]
    for sock in sockets:
        try:
...
def main():
    ...
    print("\n" + "=" * 70)
    print("  🧠 ABIN - Maximum Sophistication AI")
    print("=" * 70)
    ...
    lobes = [
        ...
        ("Notus Memory", "notus.py", 8.0),  # Big file, needs time
    ...
    print("\n✅ All 8 lobes online and connected!")
    print("\n🎮 Launching interface...")
    print("=" * 70)
    print()
